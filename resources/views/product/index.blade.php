        ...
        <tbody>
          @foreach ($product as $brg)
            <tr>
                ...
                <td>{{ $brg->qty }}</td>
                <td><center><a href="#" class="btn btn-dark"><i class="fas fa-eye"></i> Lihat</a> <a href="#" class="btn btn-dark"><i class="fas fa-user-edit"></i> Edit</a><br>
                <!-- <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapus"><i class="fas fa-trash-alt"></i>  
                Hapus</button> -->
                <form action="{{route('product.destroy', $brg->id)}}" method="post">
                    @csrf
